...
<head>
    ...
    <link rel="stylesheet" href="indexstyle.php" type="text/css" media="screen">
...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="logreg.php">LOG IN/ SIGN UP</a></li>
            <li><a href="">CART(0)</a></li>

        </ul>
    </nav>
    <div class="image">
        <img class="imgFindYourStyle" src="firstpic.jpg" alt="FIND YOUR STYLE">
    ...
    <h3>
        ...
        <....> FOR THE MOST DARING FASHION EDGE APPAREL
    </h3>

    <br />
    <div class="row">
        <div class="column">
            <img src="trenchcoat.jpg" alt="Trenchcoat" width="100%">
            <span class="photoDescTrench"> TRENCH COAT KSH. 2,800</span>
        </div>
        <div class="column">
            <img src="summervest.jpg" alt="Summer Vest" width="100%">
            <span class="photoDescVest"> SUMMER VEST KSH. 1,100</span>
        </div>
        <div class="column">
            <img src="plaidskirt.jpg" alt="Plaidskirt" width="100%">
        ...
        <div class="reviews">
            <div class="review">
                <div class="head-review">
                    <img class="imagesforreview" src="lupita.jpeg" alt="Lupita" width="250px">
                </div>
            ...
            <div class="review">
                <div class="head-review">
                    <img class="imagesforreview" src="vera.jpeg" alt="Vera" width="250px">
                </div>
                <div class="body-review">
            ...
            <div class="review">
                <div class="head-review">
                    <img class="imagesforreview" src="lilianmuli.jpg" alt="Lilian" width="250px">
                </div>
                <div class="body-review">
            ...
            <div class="review">
                <div class="head-review">
                    <img class="imagesforreview" src="betty.jpeg" alt="Betty" width="250px">
                </div>
                <div class="body-review">
